        ...
        <table className="min-w-full border border-gray-200 shadow-md rounded-lg">
          <thead className="bg-blue-800 text-white">
            <tr>
              ...
              <th className="px-4 py-2 border text-center align-middle">Subject Name</th>
              <th className="px-4 py-2 border text-center align-middle">Actions</th>
            </tr>
          </thead>
          <tbody>
            {subjects.length > 0 ? (
              subjects.map((subject, index) => (
                ...
                >
                  ...
                  <td className="px-4 py-2 border text-center align-middle">{subject.id}</td>
                  <td className="px-4 py-2 border text-center align-middle">{subject.name}</td>
